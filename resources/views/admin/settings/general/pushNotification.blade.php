                            ...
                            <div class="row">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="onesignal_content" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text($result['settings'][56]->name,  $result['settings'][56]->value, array('class'=>'form-control', 'id'=>$result['settings'][55]->name)) !!}
                                ...
                                {{ trans('labels.OnesignalAppidText') }}</span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        {!! Form::text($result['settings'][57]->name,  $result['settings'][57]->value, array('class'=>'form-control', 'id'=>$result['settings'][56]->name)) !!}
                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">
