                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    {!! Form::text($result['settings'][2]->name, $result['settings'][2]->value, array('class'=>'form-control', 'id'=>$result['settings'][2]->name)) !!}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="{{$result['settings'][3]->name}}" class="form-control">
                                                        <option @if($result['settings'][3]->value == '1')
                                                                selected
                                                                @endif
                                                                value="1"> {{ trans('labels.enable') }}</option>
                                                        <option @if($result['settings'][3]->value == '0')
                                                                selected
                                                                @endif
